...
// of JSON) as a Date() object.  This is actually the last event reported
// by the timeline API call.
checkup.lastResultTs = null;

// Timestamp reported by the last status API call.
checkup.lastStatusTs = 0;
